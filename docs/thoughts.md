...
- 程序员对待 AI 有两种态度：一种以结果为导向，渴望通过 AI 更快拿到结果；另一种以过程为导向，他们从工程本身获得意义，对于被剥夺这种体验感到不满。-- Ben Werdmuller  
  ...
  这两种情况同时出现在我身上，如果遇到的需求简单，AI就能完成了绝大部分工作，自己变成了需求说明人，代码基本不用操心，只需要提出使用哪种设计模式、以及如何进行抽象，更多的像一个需求说明人以及架构搭建人。但是在更大更难的需求中，需求整理、详细设计，为了保证AI的代码质量对其进行检查、手工修改、或者按照要求进行优化，工作流程的闭环。现在前一种状况占了主导。
